 ...
 * @Date: 2022-11-06 17:41:04
 * @LastEditors: wenreq 294491328@qq.com
 * @LastEditTime: 2022-11-06 18:02:27
 * @FilePath: /V3_Project/src/views/IndexConfig.vue
 * @Description: 
 * 
...
router.beforeEach((to) => {
  if (['hot', 'new', 'recommend'].includes(JSON.parse(JSON.stringify(to.name)))) {
